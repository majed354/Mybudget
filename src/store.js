...
export const DEFAULT_SETTINGS = {
  ...
  analysis: {
    ...
    // حتى هذا التاريخ يُحتسب التحويل إلى حساباتك صرفًا، لأن تفاصيل تلك
    // الحسابات لم تكن تصل بعد. ومنه فصاعدًا يُستبعد لأن التفاصيل صارت
    // تصل من رسائل البنك — فلا يُحصى الريال مرتين. فارغٌ = استبعاد دائم.
    ownTransfersSpendUntil: '',
